...
async def create_booking(booking_data: BookingCreate, user: User) -> BookingResponse:
    try:
        # Validate class
        ...
        return BookingResponse(
            ...
            class_date=class_instance.schedule.date().isoformat(),
            class_time=class_instance.schedule.time().isoformat(),
...
async def get_user_bookings(user: User) -> list[BookingResponse]:
    try:
        ...
        responses = [
            BookingResponse(
                ...
                class_date=booking.class_.schedule.date().isoformat(),
                class_time=booking.class_.schedule.time().isoformat(),
